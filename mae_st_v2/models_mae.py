...
from mae_st_v2.util import video_vit
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.in_chans = in_chans  # store for patchify/unpatchify
