...
#SBATCH --output=/scratch5/gautham/cvpr/logs/eval_v2_ep130_%j.log

export PYTHONUNBUFFERED=1
cd /home/gautham/Projects/C-MAE

PYTHON=/home/gautham/anaconda3/envs/voco/bin/python
FULL_CKPT=/scratch5/gautham/cvpr/checkpoints/maest_v2/checkpoint-00130.pth
CKPT=/scratch5/gautham/cvpr/checkpoints/encoder_checkpoint_v2_ep130.pth
...
FEAT_DIR=/scratch5/gautham/cvpr/features_v2_ep130
OUT_DIR=/scratch5/gautham/cvpr/linprobe_output_v2_ep130

echo "=== Step 1: Strip checkpoint ==="
